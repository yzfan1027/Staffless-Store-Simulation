...
class Car():
    ...
    def schedule(self):
        ...
        """
        self.tally_car = [{'0':[[0,1],0]},{'1':[[2],0]},{'2':[[4],0]}]
...
class Nav():
    ...
    item_position = [
    	...
    	[0.5525260612491719,0.050803656989628808,0.3487649601560062,0.9372102232516349],
    ...
    def navigating(self):
        ...
        for car in tally_car:  #2 tally car, plan route 
            ...
            for plan in plans[0]:
                ...
                route.append(self.item_position[plan]) #name_coor[1:]
                data += self.name[plan]+" " #name_coor[0]
                rospy.sleep(0.1)
