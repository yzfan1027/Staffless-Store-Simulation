...
(cl:defmethod cl:initialize-instance :after ((m <WheelsCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WheelsCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jetbot_msgs-msg:<WheelsCmd> is deprecated: use jetbot_msgs-msg:WheelsCmd instead.")))

(cl:ensure-generic-function 'vel_left-val :lambda-list '(m))
(cl:defmethod vel_left-val ((m <WheelsCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetbot_msgs-msg:vel_left-val is deprecated.  Use jetbot_msgs-msg:vel_left instead.")
  (vel_left m))

(cl:ensure-generic-function 'vel_right-val :lambda-list '(m))
(cl:defmethod vel_right-val ((m <WheelsCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetbot_msgs-msg:vel_right-val is deprecated.  Use jetbot_msgs-msg:vel_right instead.")
  (vel_right m))
