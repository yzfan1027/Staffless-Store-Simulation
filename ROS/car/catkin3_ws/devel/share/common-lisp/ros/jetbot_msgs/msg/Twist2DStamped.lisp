...
(cl:defmethod cl:initialize-instance :after ((m <Twist2DStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Twist2DStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jetbot_msgs-msg:<Twist2DStamped> is deprecated: use jetbot_msgs-msg:Twist2DStamped instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Twist2DStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetbot_msgs-msg:header-val is deprecated.  Use jetbot_msgs-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'v-val :lambda-list '(m))
(cl:defmethod v-val ((m <Twist2DStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetbot_msgs-msg:v-val is deprecated.  Use jetbot_msgs-msg:v instead.")
  (v m))

(cl:ensure-generic-function 'omega-val :lambda-list '(m))
(cl:defmethod omega-val ((m <Twist2DStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetbot_msgs-msg:omega-val is deprecated.  Use jetbot_msgs-msg:omega instead.")
  (omega m))
